...
class Ui_SammyBPLeaderboard(object):
    def setupUi(self, SammyBPLeaderboard):
        self.object = SammyBPLeaderboard
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../shared/SAMCrest.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.handler.setup_routes(self.object)
